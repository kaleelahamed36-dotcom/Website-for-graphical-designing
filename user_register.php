...
<div class="wrapper">	
	<div class="main" style="margin-top:-100px">
		...
		<h3 class="style"><a href="" style="color:black">USER REGISTRATION</a></h3>
		
			<div class="contact-form">
            
				  	
					  <form method="POST" action="" name="user_register">
                                <div>
						    ...
						    <div>
						    	...
						    	<span><input name="mobileno" type="text" class="textbox" pattern="[0-9]{10}" title="Mobile number must be exactly 10 digits" required></span>
						    </div>
                             <div>
...
if(isset($_POST['register']))
{
	...
	mysql_query("insert into user(busername,bpassword,date,mobileno,address,pinno,dist) 
	values('$username','$password','$date','$mobileno','$address','$pinno','$dist')");

echo "<script type='text/javascript'>alert('User register created');</script>";
